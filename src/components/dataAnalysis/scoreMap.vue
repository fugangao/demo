<template>
    <div class="box">
        ...
        <div class="table-box">
            <table border="true"
                style="width: 300px;height: 200px;text-align: center;position: absolute;right: 200px;top: 100px;">
                <thead>
                    <th>省份</th>
                    <th>文科</th>
                    <th>理科</th>
                ...
                <tbody>
                    <tr style="font-size: 24px;color: aqua;">
                        <td>{{ tableData.city }}</td>
                        <td>{{ tableData.value[0].value }}</td>
                        <td>{{ tableData.value[1].value }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
...
export default {
    ...
    mounted() {
        ...
        chart.on('click', (e) => {
            this.tableData.city = e.name
            let data = toolTipData.find(item => {
                return item.name === this.tableData.city
            })
            this.tableData.value = data.value
